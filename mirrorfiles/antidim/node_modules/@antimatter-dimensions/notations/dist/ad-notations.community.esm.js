...
var MixedLogarithmSciNotation = function (_super) {
  ...
  MixedLogarithmSciNotation.prototype.formatDecimal = function (value, places, placesExponent) {
    if (value.exponent < 33) {
      return scientific$2.formatDecimal(value, places, placesExponent);
    }

    return "e".concat(this.formatExponent(value.log10(), places, function (n, _) {
      return n.toString();
    }, placesExponent));
  };
