...
export const toad_seg6_lights_06005908 = Gbi.gdSPDefLights1(
    0x7f, 0x7f, 0x7f,
...
const toad_seg6_vertex_06006920 = [
...
// 0x06006A10
const toad_seg6_vertex_06006A10 = [
...
// 0x06006B10
const toad_seg6_vertex_06006B10 = [
    [[     0,   -143,      8], 0, [  -546,    672], [0xf8, 0x85, 0xe4, 0xff]],
    [[   -56,   -113,      7], 0, [  -560,    370], [0xab, 0xae, 0xd4, 0xff]],
...
// 0x06006BD0
const toad_seg6_vertex_06006BD0 = [
...
// 0x06006CC0
const toad_seg6_vertex_06006CC0 = [
...
// 0x06006DC0
const toad_seg6_vertex_06006DC0 = [
    [[  -141,     91,    -35], 0, [   472,   1082], [0xad, 0x52, 0xd1, 0xff]],
...
// 0x06006EC0
const toad_seg6_vertex_06006EC0 = [
    [[  -141,    -44,     37], 0, [  -168,    914], [0xba, 0xa7, 0x37, 0xff]],
...
// 0x06006FB0
const toad_seg6_vertex_06006FB0 = [
...
// 0x060070B0
const toad_seg6_vertex_060070B0 = [
...
// 0x060071B0
const toad_seg6_vertex_060071B0 = [
...
// 0x06007200
const toad_seg6_vertex_06007200 = [
...
export const toad_seg6_dl_06007300 = [
    Gbi.gsDPSetTextureImage(Gbi.G_IM_FMT_RGBA, Gbi.G_IM_SIZ_16b, 1, toad_seg6_texture_06005920),
    Gbi.gsDPLoadSync(),
    Gbi.gsDPLoadBlock(Gbi.G_TX_LOADTILE, 0, 0, 32 * 32 - 1, Gbi.CALC_DXT(32, Gbi.G_IM_SIZ_16b_BYTES)),
    Gbi.gsSPLight(toad_seg6_lights_06005908.l, 1),
    Gbi.gsSPLight(toad_seg6_lights_06005908.a, 2),
    Gbi.gsSPVertex(toad_seg6_vertex_06006920, 15, 0),
    Gbi.gsSP2Triangles( 0,  1,  2, 0x0,  3,  0,  4, 0x0),
    Gbi.gsSP2Triangles( 2,  4,  0, 0x0,  0,  5,  6, 0x0),
    Gbi.gsSP2Triangles( 3,  5,  0, 0x0,  6,  1,  0, 0x0),
    Gbi.gsSP2Triangles( 6,  5,  7, 0x0,  3,  7,  5, 0x0),
    Gbi.gsSP2Triangles( 1,  6,  8, 0x0,  8,  6,  9, 0x0),
    Gbi.gsSP2Triangles( 7,  9,  6, 0x0, 10,  9,  7, 0x0),
    Gbi.gsSP2Triangles( 3, 11,  7, 0x0,  7, 11, 10, 0x0),
    Gbi.gsSP2Triangles( 8, 12,  1, 0x0, 13, 14,  8, 0x0),
    Gbi.gsSP2Triangles( 9, 13,  8, 0x0, 12,  8, 14, 0x0),
    Gbi.gsSPVertex(toad_seg6_vertex_06006A10, 16, 0),
    Gbi.gsSP2Triangles( 0,  1,  2, 0x0,  3,  4,  5, 0x0),
    Gbi.gsSP2Triangles( 5,  6,  3, 0x0,  7,  8,  9, 0x0),
    Gbi.gsSP2Triangles( 9, 10,  7, 0x0,  1, 11, 12, 0x0),
    Gbi.gsSP2Triangles(13, 11,  1, 0x0,  1, 12,  2, 0x0),
    Gbi.gsSP2Triangles(13,  1,  0, 0x0,  2, 12, 14, 0x0),
    Gbi.gsSP1Triangle( 2, 14, 15, 0x0),
    Gbi.gsSPVertex(toad_seg6_vertex_06006B10, 12, 0),
    Gbi.gsSP2Triangles( 0,  1,  2, 0x0,  2,  1,  3, 0x0),
    Gbi.gsSP2Triangles( 4,  0,  5, 0x0,  4,  5,  6, 0x0),
    Gbi.gsSP2Triangles( 2,  3,  7, 0x0,  5,  0,  2, 0x0),
    Gbi.gsSP2Triangles( 5,  2,  8, 0x0,  8,  2,  7, 0x0),
    Gbi.gsSP2Triangles( 8,  7,  9, 0x0,  6,  5,  8, 0x0),
    Gbi.gsSP2Triangles( 6,  8, 10, 0x0, 10,  8,  9, 0x0),
    Gbi.gsSP1Triangle(10,  9, 11, 0x0),
    Gbi.gsSPEndDisplayList(),
];

// 0x06007498 - 0x060076C0
export const toad_seg6_dl_06007498 = [
    Gbi.gsDPSetTextureImage(Gbi.G_IM_FMT_RGBA, Gbi.G_IM_SIZ_16b, 1, toad_seg6_texture_06006120),
    Gbi.gsDPLoadSync(),
    Gbi.gsDPLoadBlock(Gbi.G_TX_LOADTILE, 0, 0, 32 * 32 - 1, Gbi.CALC_DXT(32, Gbi.G_IM_SIZ_16b_BYTES)),
    Gbi.gsSPVertex(toad_seg6_vertex_06006BD0, 15, 0),
    Gbi.gsSP2Triangles( 0,  1,  2, 0x0,  3,  0,  2, 0x0),
    Gbi.gsSP2Triangles( 2,  1,  4, 0x0,  2,  4,  5, 0x0),
    Gbi.gsSP2Triangles( 3,  2,  6, 0x0,  6,  2,  5, 0x0),
    Gbi.gsSP2Triangles( 7,  8,  9, 0x0,  8, 10,  9, 0x0),
    Gbi.gsSP2Triangles( 8, 11, 10, 0x0, 12, 13, 14, 0x0),
    Gbi.gsSPVertex(toad_seg6_vertex_06006CC0, 16, 0),
    Gbi.gsSP2Triangles( 0,  1,  2, 0x0,  3,  4,  5, 0x0),
    ...
    Gbi.gsSP2Triangles(14,  1,  0, 0x0, 15, 14,  0, 0x0),
    Gbi.gsSPVertex(toad_seg6_vertex_06006DC0, 16, 0),
    Gbi.gsSP2Triangles( 0,  1,  2, 0x0,  3,  4,  5, 0x0),
    Gbi.gsSP2Triangles( 6,  7,  8, 0x0,  9,  7,  6, 0x0),
    Gbi.gsSP2Triangles( 9, 10,  7, 0x0, 11, 10,  9, 0x0),
    Gbi.gsSP2Triangles(12,  4,  3, 0x0, 13, 14, 15, 0x0),
    Gbi.gsSPVertex(toad_seg6_vertex_06006EC0, 15, 0),
    Gbi.gsSP2Triangles( 0,  1,  2, 0x0,  3,  4,  5, 0x0),
    Gbi.gsSP2Triangles( 3,  5,  6, 0x0,  7,  3,  6, 0x0),
    Gbi.gsSP2Triangles( 7,  6,  8, 0x0,  9, 10, 11, 0x0),
    Gbi.gsSP2Triangles(12,  7,  8, 0x0, 11, 10, 13, 0x0),
    Gbi.gsSP1Triangle(11, 13, 14, 0x0),
    Gbi.gsSPVertex(toad_seg6_vertex_06006FB0, 16, 0),
    ...
    Gbi.gsSPVertex(toad_seg6_vertex_060070B0, 16, 0),
    Gbi.gsSP2Triangles( 0,  1,  2, 0x0,  3,  0,  2, 0x0),
    Gbi.gsSP2Triangles( 3,  2,  4, 0x0,  2,  1,  5, 0x0),
    Gbi.gsSP2Triangles( 6,  7,  8, 0x0,  9, 10, 11, 0x0),
    Gbi.gsSP2Triangles(11, 10, 12, 0x0,  9, 13, 10, 0x0),
    Gbi.gsSP2Triangles(14, 13,  9, 0x0, 14, 15, 13, 0x0),
    Gbi.gsSPVertex(toad_seg6_vertex_060071B0, 5, 0),
    Gbi.gsSP2Triangles( 0,  1,  2, 0x0,  0,  3,  1, 0x0),
    Gbi.gsSP1Triangle( 4,  3,  0, 0x0),
    Gbi.gsSPEndDisplayList(),
];

// 0x060076C0 - 0x06007710
export const toad_seg6_dl_060076C0 = [
    Gbi.gsSPVertex(toad_seg6_vertex_06007200, 16, 0),
    Gbi.gsSP2Triangles( 0,  1,  2, 0x0,  3,  4,  5, 0x0),
...
export const toad_seg6_dl_06007710 = [
    Gbi.gsDPPipeSync(),
    ...
    Gbi.gsSPDisplayList(toad_seg6_dl_06007300),
    Gbi.gsSPDisplayList(toad_seg6_dl_06007498),
    Gbi.gsSPTexture(0xFFFF, 0xFFFF, 0, Gbi.G_TX_RENDERTILE, Gbi.G_OFF),
    Gbi.gsDPPipeSync(),
    Gbi.gsDPSetCombineMode(Gbi.G_CC_SHADEFADEA, Gbi.G_CC_SHADEFADEA),
    Gbi.gsSPDisplayList(toad_seg6_dl_060076C0),
    Gbi.gsDPPipeSync(),
    Gbi.gsSPEndDisplayList(),
];

// 0x06007788 - 0x06007808
export const toad_seg6_us_dl_06007788 = [
    Gbi.gsDPPipeSync(),
    Gbi.gsDPSetCombineMode(Gbi.G_CC_MODULATERGBFADE, Gbi.G_CC_MODULATERGBFADE),
    Gbi.gsDPSetTile(Gbi.G_IM_FMT_RGBA, Gbi.G_IM_SIZ_16b, 0, 0, Gbi.G_TX_LOADTILE, 0, Gbi.G_TX_WRAP | Gbi.G_TX_NOMIRROR, Gbi.G_TX_NOMASK, Gbi.G_TX_NOLOD, Gbi.G_TX_WRAP | Gbi.G_TX_NOMIRROR, Gbi.G_TX_NOMASK, Gbi.G_TX_NOLOD),
...
// 0x06007788
const toad_seg6_lights_06007788 = Gbi.gdSPDefLights1(
    0x21, 0x13, 0x5a,
    0x42, 0x27, 0xb5, 0x28, 0x28, 0x28
);

// 0x060077A0
const toad_seg6_vertex_060077A0 = [
...
// 0x060078A0
const toad_seg6_vertex_060078A0 = [
...
export const toad_seg6_dl_06007960 = [
    Gbi.gsSPLight(toad_seg6_lights_06007788.l, 1),
    Gbi.gsSPLight(toad_seg6_lights_06007788.a, 2),
    Gbi.gsSPVertex(toad_seg6_vertex_060077A0, 16, 0),
    Gbi.gsSP2Triangles( 0,  1,  2, 0x0,  3,  4,  5, 0x0),
    Gbi.gsSP2Triangles( 4,  6,  7, 0x0,  4,  7,  8, 0x0),
    Gbi.gsSP2Triangles( 8,  5,  4, 0x0,  9,  7,  6, 0x0),
    Gbi.gsSP2Triangles(10,  8,  7, 0x0, 10,  7,  9, 0x0),
    Gbi.gsSP2Triangles(10, 11,  8, 0x0, 12,  8, 11, 0x0),
    Gbi.gsSP2Triangles(12,  5,  8, 0x0, 10,  9, 13, 0x0),
    Gbi.gsSP2Triangles( 0, 14,  1, 0x0, 15,  0,  2, 0x0),
    Gbi.gsSPVertex(toad_seg6_vertex_060078A0, 12, 0),
    Gbi.gsSP2Triangles( 0,  1,  2, 0x0,  2,  3,  0, 0x0),
    Gbi.gsSP2Triangles( 4,  3,  2, 0x0,  0,  5,  1, 0x0),
    Gbi.gsSP2Triangles( 6,  7,  8, 0x0,  6,  8,  9, 0x0),
    Gbi.gsSP2Triangles( 5,  9,  8, 0x0,  4,  2, 10, 0x0),
    Gbi.gsSP2Triangles( 8,  1,  5, 0x0,  8,  7, 11, 0x0),
    Gbi.gsSPEndDisplayList(),
];

// 0x06007A48 - 0x06007A80
export const toad_seg6_dl_06007A48 = [
    Gbi.gsDPPipeSync(),
    Gbi.gsDPSetCombineMode(Gbi.G_CC_SHADEFADEA, Gbi.G_CC_SHADEFADEA),
    Gbi.gsSPClearGeometryMode(Gbi.G_CULL_BACK),
    Gbi.gsSPDisplayList(toad_seg6_dl_06007960),
    Gbi.gsDPPipeSync(),
...
export const toad_seg6_us_dl_06007B00 = [
    Gbi.gsDPPipeSync(),
    Gbi.gsDPSetCombineMode(Gbi.G_CC_SHADEFADEA, Gbi.G_CC_SHADEFADEA),
    Gbi.gsSPDisplayList(toad_seg6_dl_06007960),
    Gbi.gsDPPipeSync(),
...
// 0x06007A80
const toad_seg6_lights_06007A80 = Gbi.gdSPDefLights1(
    0x7f, 0x7f, 0x7f,
    0xff, 0xff, 0xff, 0x28, 0x28, 0x28
);

// 0x06007A98
const toad_seg6_lights_06007A98 = Gbi.gdSPDefLights1(
    0x7f, 0x6a, 0x50,
    0xfe, 0xd5, 0xa1, 0x28, 0x28, 0x28
);

// 0x06007AB0
const toad_seg6_vertex_06007AB0 = [
...
// 0x06007B90
const toad_seg6_vertex_06007B90 = [
...
// 0x06007C50
const toad_seg6_vertex_06007C50 = [
    [[    29,      9,     49], 0, [     0,      0], [0x2b, 0x33, 0x6b, 0xff]],
    [[    57,      9,     22], 0, [     0,      0], [0x67, 0x41, 0x23, 0xff]],
...
export const toad_seg6_dl_06007D10 = [
    Gbi.gsSPLight(toad_seg6_lights_06007A80.l, 1),
    Gbi.gsSPLight(toad_seg6_lights_06007A80.a, 2),
    Gbi.gsSPVertex(toad_seg6_vertex_06007AB0, 14, 0),
    Gbi.gsSP2Triangles( 0,  1,  2, 0x0,  3,  4,  5, 0x0),
    Gbi.gsSP2Triangles( 3,  5,  6, 0x0,  3,  6,  7, 0x0),
    Gbi.gsSP2Triangles( 7,  8,  3, 0x0,  3,  9,  4, 0x0),
    Gbi.gsSP2Triangles( 3,  8,  9, 0x0, 10,  7,  6, 0x0),
    Gbi.gsSP2Triangles(10,  6, 11, 0x0, 11,  6,  5, 0x0),
    Gbi.gsSP2Triangles( 7,  0,  8, 0x0,  0,  7, 10, 0x0),
    Gbi.gsSP2Triangles( 2, 12, 13, 0x0,  2,  1, 12, 0x0),
    Gbi.gsSP2Triangles( 2,  8,  0, 0x0,  2, 13,  9, 0x0),
    Gbi.gsSP1Triangle( 2,  9,  8, 0x0),
    Gbi.gsSPVertex(toad_seg6_vertex_06007B90, 12, 0),
    Gbi.gsSP2Triangles( 0,  1,  2, 0x0,  3,  4,  5, 0x0),
    Gbi.gsSP2Triangles( 3,  5,  6, 0x0,  7,  8,  1, 0x0),
    Gbi.gsSP2Triangles( 7,  1,  9, 0x0,  7, 10,  8, 0x0),
    Gbi.gsSP2Triangles( 7,  9,  4, 0x0,  5,  4,  9, 0x0),
    Gbi.gsSP2Triangles( 5,  9,  0, 0x0,  0,  9,  1, 0x0),
    Gbi.gsSP2Triangles(11,  6,  0, 0x0, 11,  0,  2, 0x0),
    Gbi.gsSP1Triangle( 0,  6,  5, 0x0),
    Gbi.gsSPLight(toad_seg6_lights_06007A98.l, 1),
    Gbi.gsSPLight(toad_seg6_lights_06007A98.a, 2),
    Gbi.gsSPVertex(toad_seg6_vertex_06007C50, 12, 0),
    Gbi.gsSP2Triangles( 0,  1,  2, 0x0,  2,  3,  0, 0x0),
    Gbi.gsSP2Triangles( 4,  2,  1, 0x0,  4,  1,  5, 0x0),
    Gbi.gsSP2Triangles( 6,  7,  2, 0x0,  6,  2,  4, 0x0),
    Gbi.gsSP2Triangles( 2,  7,  3, 0x0,  5,  8,  4, 0x0),
    Gbi.gsSP2Triangles( 6,  8,  9, 0x0,  6,  4,  8, 0x0),
    Gbi.gsSP2Triangles(10,  3,  7, 0x0,  7, 11, 10, 0x0),
    Gbi.gsSP2Triangles( 7,  6, 11, 0x0,  9, 11,  6, 0x0),
    Gbi.gsSPEndDisplayList(),
];

// 0x06007EB0 - 0x06007ED8
export const toad_seg6_dl_06007EB0 = [
    Gbi.gsDPPipeSync(),
    Gbi.gsDPSetCombineMode(Gbi.G_CC_SHADEFADEA, Gbi.G_CC_SHADEFADEA),
    Gbi.gsSPDisplayList(toad_seg6_dl_06007D10),
    Gbi.gsDPPipeSync(),
    Gbi.gsSPEndDisplayList(),
];

// 0x06007ED8
const toad_seg6_lights_06007ED8 = Gbi.gdSPDefLights1(
    0x7f, 0x6a, 0x50,
    0xfe, 0xd5, 0xa1, 0x28, 0x28, 0x28
);

// 0x06007EF0
const toad_seg6_vertex_06007EF0 = [
...
// 0x06007FF0
const toad_seg6_vertex_06007FF0 = [
    [[     4,    -57,     18], 0, [     0,      0], [0x62, 0xd9, 0x45, 0xff]],
    [[   -17,    -43,     28], 0, [     0,      0], [0xcd, 0xf9, 0x73, 0xff]],
...
export const toad_seg6_dl_060080C0 = [
    Gbi.gsSPLight(toad_seg6_lights_06007ED8.l, 1),
    Gbi.gsSPLight(toad_seg6_lights_06007ED8.a, 2),
    Gbi.gsSPVertex(toad_seg6_vertex_06007EF0, 16, 0),
    Gbi.gsSP2Triangles( 0,  1,  2, 0x0,  1,  0,  3, 0x0),
    Gbi.gsSP2Triangles( 0,  2,  4, 0x0,  4,  3,  0, 0x0),
    Gbi.gsSP2Triangles( 2,  5,  6, 0x0,  6,  7,  2, 0x0),
    Gbi.gsSP2Triangles( 4,  2,  7, 0x0,  5,  2,  1, 0x0),
    Gbi.gsSP2Triangles( 7,  8,  4, 0x0,  4,  9,  3, 0x0),
    Gbi.gsSP2Triangles( 4,  8, 10, 0x0, 11,  9,  4, 0x0),
    Gbi.gsSP2Triangles( 4, 10, 11, 0x0,  1,  3, 12, 0x0),
    Gbi.gsSP2Triangles(11,  3,  9, 0x0, 12,  3, 11, 0x0),
    Gbi.gsSP2Triangles( 7, 13,  8, 0x0,  7,  6, 13, 0x0),
    Gbi.gsSP2Triangles(10, 14, 15, 0x0, 10, 15, 11, 0x0),
    Gbi.gsSPVertex(toad_seg6_vertex_06007FF0, 13, 0),
    Gbi.gsSP2Triangles( 0,  1,  2, 0x0,  0,  3,  1, 0x0),
    Gbi.gsSP2Triangles( 2,  4,  0, 0x0,  5,  6,  7, 0x0),
    Gbi.gsSP2Triangles( 7,  8,  5, 0x0,  2,  8,  4, 0x0),
    Gbi.gsSP2Triangles( 2,  5,  8, 0x0,  5,  2,  9, 0x0),
    Gbi.gsSP2Triangles( 5,  9,  6, 0x0,  9,  2,  1, 0x0),
    Gbi.gsSP2Triangles(10,  9,  1, 0x0, 10,  1, 11, 0x0),
    Gbi.gsSP2Triangles( 9, 12,  6, 0x0,  9, 10, 12, 0x0),
    Gbi.gsSPEndDisplayList(),
];

// 0x060081F8 - 0x06008220
export const toad_seg6_dl_060081F8 = [
    Gbi.gsDPPipeSync(),
    Gbi.gsDPSetCombineMode(Gbi.G_CC_SHADEFADEA, Gbi.G_CC_SHADEFADEA),
    Gbi.gsSPDisplayList(toad_seg6_dl_060080C0),
    Gbi.gsDPPipeSync(),
    Gbi.gsSPEndDisplayList(),
];

// 0x06008220
const toad_seg6_lights_06008220 = Gbi.gdSPDefLights1(
    0x7f, 0x6a, 0x50,
    0xfe, 0xd5, 0xa1, 0x28, 0x28, 0x28
);

// 0x06008238
const toad_seg6_vertex_06008238 = [
...
// 0x06008338
const toad_seg6_vertex_06008338 = [
...
export const toad_seg6_dl_060083E8 = [
    Gbi.gsSPLight(toad_seg6_lights_06008220.l, 1),
    Gbi.gsSPLight(toad_seg6_lights_06008220.a, 2),
    Gbi.gsSPVertex(toad_seg6_vertex_06008238, 16, 0),
    Gbi.gsSP2Triangles( 0,  1,  2, 0x0,  3,  4,  0, 0x0),
    Gbi.gsSP2Triangles( 5,  1,  0, 0x0,  0,  4,  6, 0x0),
    Gbi.gsSP2Triangles( 0,  7,  8, 0x0,  8,  3,  0, 0x0),
    Gbi.gsSP2Triangles( 2,  7,  0, 0x0,  6,  5,  0, 0x0),
    Gbi.gsSP2Triangles( 9, 10,  7, 0x0,  7, 11,  8, 0x0),
    Gbi.gsSP2Triangles( 7,  2,  9, 0x0, 11,  7, 10, 0x0),
    Gbi.gsSP2Triangles(12,  3,  8, 0x0, 12,  8, 11, 0x0),
    Gbi.gsSP2Triangles( 4,  3,  6, 0x0,  6,  3, 12, 0x0),
    Gbi.gsSP2Triangles( 1,  9,  2, 0x0, 12, 11, 10, 0x0),
    Gbi.gsSP2Triangles( 6, 12, 13, 0x0,  6, 14, 15, 0x0),
    Gbi.gsSP2Triangles( 6, 15,  5, 0x0, 13, 14,  6, 0x0),
    Gbi.gsSPVertex(toad_seg6_vertex_06008338, 11, 0),
    Gbi.gsSP2Triangles( 0,  1,  2, 0x0,  1,  3,  2, 0x0),
    Gbi.gsSP2Triangles( 2,  4,  0, 0x0,  4,  5,  0, 0x0),
    Gbi.gsSP2Triangles( 4,  6,  5, 0x0,  7,  0,  5, 0x0),
    Gbi.gsSP2Triangles( 8,  7,  5, 0x0,  3,  1,  9, 0x0),
    Gbi.gsSP2Triangles( 1,  0,  7, 0x0,  9,  1,  7, 0x0),
    Gbi.gsSP2Triangles( 8, 10,  7, 0x0,  9,  7, 10, 0x0),
    Gbi.gsSPEndDisplayList(),
];

// 0x06008520 - 0x06008560
export const toad_seg6_dl_06008520 = [
    Gbi.gsDPPipeSync(),
    Gbi.gsDPSetCombineMode(Gbi.G_CC_SHADEFADEA, Gbi.G_CC_SHADEFADEA),
    Gbi.gsSPDisplayList(toad_seg6_dl_060083E8),
    Gbi.gsDPPipeSync(),
...
export const toad_seg6_us_dl_06008608 = [
    Gbi.gsDPPipeSync(),
    Gbi.gsDPSetCombineMode(Gbi.G_CC_SHADEFADEA, Gbi.G_CC_SHADEFADEA),
    Gbi.gsSPDisplayList(toad_seg6_dl_060083E8),
    Gbi.gsDPPipeSync(),
...
// 0x06008560
const toad_seg6_lights_06008560 = Gbi.gdSPDefLights1(
    0x34, 0x20, 0x0d,
    0x68, 0x40, 0x1b, 0x28, 0x28, 0x28
);

// 0x06008578
const toad_seg6_vertex_06008578 = [
...
// 0x06008678
const toad_seg6_vertex_06008678 = [
    [[   -13,      7,     47], 0, [     0,      0], [0xda, 0x51, 0x59, 0xff]],
    [[    14,      7,     47], 0, [     0,      0], [0x34, 0x3b, 0x63, 0xff]],
...
export const toad_seg6_dl_06008748 = [
    Gbi.gsSPLight(toad_seg6_lights_06008560.l, 1),
    Gbi.gsSPLight(toad_seg6_lights_06008560.a, 2),
    Gbi.gsSPVertex(toad_seg6_vertex_06008578, 16, 0),
    Gbi.gsSP2Triangles( 0,  1,  2, 0x0,  0,  2,  3, 0x0),
    Gbi.gsSP2Triangles( 2,  4,  5, 0x0,  2,  5,  6, 0x0),
    Gbi.gsSP2Triangles( 2,  7,  3, 0x0,  2,  8,  7, 0x0),
    Gbi.gsSP2Triangles( 2,  9,  8, 0x0,  2,  6,  9, 0x0),
    Gbi.gsSP2Triangles( 2,  1, 10, 0x0,  2, 10,  4, 0x0),
    Gbi.gsSP2Triangles( 7, 11,  0, 0x0, 12, 11,  7, 0x0),
    Gbi.gsSP2Triangles(12,  7,  8, 0x0,  7,  0,  3, 0x0),
    Gbi.gsSP2Triangles(12,  8,  9, 0x0, 10,  5,  4, 0x0),
    Gbi.gsSP2Triangles(12,  9, 13, 0x0, 14,  9,  6, 0x0),
    Gbi.gsSP2Triangles(14, 13,  9, 0x0,  5, 14,  6, 0x0),
    Gbi.gsSP1Triangle(10, 15,  5, 0x0),
    Gbi.gsSPVertex(toad_seg6_vertex_06008678, 13, 0),
    Gbi.gsSP2Triangles( 0,  1,  2, 0x0,  0,  2,  3, 0x0),
    Gbi.gsSP2Triangles( 3,  4,  0, 0x0,  2,  5,  6, 0x0),
    Gbi.gsSP2Triangles( 2,  6,  3, 0x0,  2,  1,  7, 0x0),
    Gbi.gsSP2Triangles( 7,  5,  2, 0x0,  8,  4,  3, 0x0),
    Gbi.gsSP2Triangles( 8,  3,  6, 0x0,  9,  7,  1, 0x0),
    Gbi.gsSP2Triangles( 7, 10,  5, 0x0,  5, 10, 11, 0x0),
    Gbi.gsSP2Triangles(11,  6,  5, 0x0, 11, 12,  6, 0x0),
    Gbi.gsSP1Triangle( 6, 12,  8, 0x0),
    Gbi.gsSPEndDisplayList(),
];

// 0x06008890 - 0x060088B8
export const toad_seg6_dl_06008890 = [
    Gbi.gsDPPipeSync(),
    Gbi.gsDPSetCombineMode(Gbi.G_CC_SHADEFADEA, Gbi.G_CC_SHADEFADEA),
    Gbi.gsSPDisplayList(toad_seg6_dl_06008748),
    Gbi.gsDPPipeSync(),
    Gbi.gsSPEndDisplayList(),
];

// 0x060088B8
const toad_seg6_lights_060088B8 = Gbi.gdSPDefLights1(
    0x34, 0x20, 0x0d,
    0x68, 0x40, 0x1b, 0x28, 0x28, 0x28
);

// 0x060088D0
const toad_seg6_vertex_060088D0 = [
...
// 0x060089D0
const toad_seg6_vertex_060089D0 = [
...
export const toad_seg6_dl_06008A90 = [
    Gbi.gsSPLight(toad_seg6_lights_060088B8.l, 1),
    Gbi.gsSPLight(toad_seg6_lights_060088B8.a, 2),
    Gbi.gsSPVertex(toad_seg6_vertex_060088D0, 16, 0),
    Gbi.gsSP2Triangles( 0,  1,  2, 0x0,  0,  3,  4, 0x0),
    Gbi.gsSP2Triangles( 0,  4,  1, 0x0,  0,  2,  5, 0x0),
    Gbi.gsSP2Triangles( 0,  5,  6, 0x0,  0,  6,  7, 0x0),
    Gbi.gsSP2Triangles( 0,  8,  3, 0x0,  0,  9,  8, 0x0),
    Gbi.gsSP2Triangles( 0, 10,  9, 0x0,  0,  7, 10, 0x0),
    Gbi.gsSP2Triangles( 8, 11, 12, 0x0,  8,  9, 11, 0x0),
    Gbi.gsSP2Triangles( 8, 12,  4, 0x0,  8,  4,  3, 0x0),
    Gbi.gsSP2Triangles(10, 11,  9, 0x0,  6,  5,  2, 0x0),
    Gbi.gsSP2Triangles(10, 13, 14, 0x0, 10,  7, 13, 0x0),
    Gbi.gsSP2Triangles(10, 14, 11, 0x0, 13,  7,  6, 0x0),
    Gbi.gsSP2Triangles(13,  6, 15, 0x0,  6,  2, 15, 0x0),
    Gbi.gsSPVertex(toad_seg6_vertex_060089D0, 12, 0),
    Gbi.gsSP2Triangles( 0,  1,  2, 0x0,  0,  2,  3, 0x0),
    Gbi.gsSP2Triangles( 1,  0,  4, 0x0,  0,  3,  5, 0x0),
    Gbi.gsSP2Triangles( 0,  5,  6, 0x0,  6,  4,  0, 0x0),
    Gbi.gsSP2Triangles( 7,  5,  3, 0x0,  3,  8,  7, 0x0),
    Gbi.gsSP2Triangles( 3,  2,  8, 0x0,  1,  4,  9, 0x0),
    Gbi.gsSP2Triangles(10,  8,  2, 0x0,  2, 11, 10, 0x0),
    Gbi.gsSP2Triangles( 2,  1, 11, 0x0,  9, 11,  1, 0x0),
    Gbi.gsSPEndDisplayList(),
];

// 0x06008BD8 - 0x06008C00
export const toad_seg6_dl_06008BD8 = [
    Gbi.gsDPPipeSync(),
    Gbi.gsDPSetCombineMode(Gbi.G_CC_SHADEFADEA, Gbi.G_CC_SHADEFADEA),
    Gbi.gsSPDisplayList(toad_seg6_dl_06008A90),
    Gbi.gsDPPipeSync(),
    Gbi.gsSPEndDisplayList(),
];